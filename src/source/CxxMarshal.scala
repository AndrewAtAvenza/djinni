...
class CxxMarshal(spec: Spec) extends Marshal(spec) {
  ...
  override def typename(tm: MExpr): String = toCxxType(tm, None, Seq())
  def typename(tm: MExpr, scopeSymbols: Seq[String]): String = toCxxType(tm, None, scopeSymbols)
  ...
  override def fqTypename(tm: MExpr): String = toCxxType(tm, Some(spec.cppNamespace), Seq())
  ...
  def returnType(ret: Option[TypeRef], scopeSymbols: Seq[String]): String = {
    ret.fold("void")(toCxxType(_, None, scopeSymbols))
  }
  override def returnType(ret: Option[TypeRef]): String = ret.fold("void")(toCxxType(_, None))
  override def fqReturnType(ret: Option[TypeRef]): String = {
    ret.fold("void")(toCxxType(_, Some(spec.cppNamespace)))
  }
  ...
  private def toCxxType(ty: TypeRef, namespace: Option[String] = None, scopeSymbols: Seq[String] = Seq()): String =
    toCxxType(ty.resolved, namespace, scopeSymbols)

  private def toCxxType(tm: MExpr, namespace: Option[String], scopeSymbols: Seq[String]): String = {
  ...
  private def toCppParamType(tm: MExpr, namespace: Option[String] = None, scopeSymbols: Seq[String] = Seq()): String = {
    val cppType = toCxxType(tm, namespace, scopeSymbols)
